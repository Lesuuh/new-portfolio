...
export const projects = [
...

  {
    ...
    description:
      "Clicon – An eCommerce web app for exploring and purchasing electronics. Users can browse products by category, view detailed product pages, add items to a cart or wishlist, and manage their orders. Supports both guest and registered users. Built with React, TypeScript, Tailwind CSS, and Firebase.",
